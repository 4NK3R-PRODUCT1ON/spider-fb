...
\033[0;1m╔═══════════════════════════════════════════╗
\033[0;1m║\033[33;1m* \033[34;1mAUTOR  \033[1;93m: \033[0;1mANKER  \033[1;93m                   
\033[0;1m║\033[33;1m* \033[34;1mYT  \033[1;93m    : \033[0;1m\033[4mYotube/ANKER PRODUCTION\033[0m \033[1;93m                  
\033[0;1m║\033[33;1m* \033[34;1mWhatsApp  \033[1;93m : \033[0;1m\033[4m+12349850908\033[0m \033[1;93m       
\033[0;1m╚═══════════════════════════════════════════╝
"""
...
def siapa():
	...
	if nama =="":
		print"\033[1;96m[!] \033[1;91mIsi yang benar jangan ngasal"
		time.sleep(1)
		siapa()
	else:
		os.system('clear')
		jalan("\033[1;97mSelamat datang \033[1;92m" +nama+ "\n\033[1;97mGunakan dengan bijak, Subscribe dlu chanel anker !!")
		time.sleep(1)
		loginSC()
...
def loginSC():
	os.system('clear')
	print"\033[1;97mSilahkan Subscribe dlu, kalo udh subscribe nanti gw kasih tau tinggal chat gw\n"
	...
	if username =="ANKERBNT" and password =="SUBSCRIBEDLU":
		print"\033[1;96m[✓] \033[1;92mLogin success"
		time.sleep(1)
		login()
	else:
		print"\033[1;96m[!] \033[1;91mSalah makanya subscribe dlu!!"
		os.system('xdg-open https://www.youtube.com/channel/UC8f7vtzQnb-VBiIiEBMTOaw')
                time.sleep(1)
                LoginSC()
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;96m[☆] \x1b[1;93mJANGAN BUAT AKUN DI FB TAPI DI CROME  \x1b[1;96m[☆]' )
		print('\033[1;96m[☆] \x1b[1;93mLOGIN AKUN FACEBOOK LU  \x1b[1;96m[☆]' )
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mAkun LU kena checkpoint udh gw duga makanya baca")
			os.system('xdg-open https://www.youtube.com/channel/UC8f7vtzQnb-VBiIiEBMTOaw')
			time.sleep(1)
			keluar()
		else:
